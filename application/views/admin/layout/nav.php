...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?= base_url('admin/route'); ?>" class="brand-link">
    <img src="<?= base_url('assets/image/logo.png'); ?>" alt="Amikom Purwokerto" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">IEANS E-Learning</span>
  </a>
