...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2021 at 08:15 AM
...
(10, 'Ikhza Man Utd', 'akhmadikhza123@gmail.com', 'cobax.jpg', '$2y$10$BErMAZcMqlRgPV2c.v1GVuHAUIYPBwCSCEk62VppghQ2udJtdb6ai', 1, 1, '2020-12-02 19:56:46', '2020-11-27 19:34:11'),
(25, 'Dosen', 'mangujang@gmail.com', 'default.png', '$2y$10$eSzrboGGFdgTDYl2D1QqLePvwvm0ArDNUVX8QOieW3qKB/oRggpyq', 3, 1, '2020-12-07 19:20:33', '2020-12-07 12:20:33'),
(38, 'Bhismar Muhammad D Y', 'bhismar.mdy@gmail.com', 'default.png', '$2y$10$e1U0wH1/WUJp3EmTPhUSyuayylvU9kGG5l3C2N2ydTZq0F/BVZnwS', 2, 0, '2020-12-07 23:41:04', '2020-12-07 16:41:04'),
(40, 'Ikhza', 'ikhzabeatles11@gmail.com', 'me_ikhza.jpg', '$2y$10$I6/FerovoCUIpdwLrdg3u.7cibdVFbU5T9FFRtRvIY/Cb3q3LgYSi', 2, 1, '2020-12-08 07:16:28', '2020-12-08 00:16:28');
...
(1, 'cloud-computing-if18s', 'Cloud Computing IF18S', 1, '2020-12-08 12:31:59'),
(2, 'pmo-2-if18s', 'PMO 2 IF18S', 2, '2020-12-09 07:40:02'),
(4, 'teori-graf-if18s', 'Teori Graf IF18S ', 3, '2020-12-01 03:28:16'),
(5, 'pcd-if18s', 'PCD IF18S', 4, '2020-12-01 07:39:52'),
(6, 'mppl-if18s', 'MPPL IF18S', 5, '2020-12-01 03:29:26'),
(7, 'kij-if18s', 'KIJ IF18S', 6, '2020-12-01 03:34:47'),
(8, 'bahasa-indonesia-if18s', 'Bahasa Indonesia IF18S', 7, '2020-12-08 12:33:11'),
(9, 'basis-data-if18s', 'Basis Data IF18S', 8, '2020-12-09 08:54:33'),
(10, 'mang-ujang', 'Mang Ujang', 9, '2020-12-09 08:56:00');
...
--
ALTER TABLE `komen`
  MODIFY `id_komen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
